...
func DeployApp(dep *models.Deployment, app *models.App, appContextPath, imageTag, containerName string, db *sql.DB, logfile *os.File, logger *utils.DeploymentLogger) error {
